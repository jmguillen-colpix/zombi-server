...
function _exec(server, params, callback) {
    ...
    axios({
        ...
        if (typeof response.data === "undefined" ||
            ...
            if (typeof callback === "function") {
                callback("Malformed server response", false);
            }
        }
        else {
        ...
        if (error.request) { // The request was made but no response was received. `error.request` is an instance of XMLHttpRequest
            if (typeof callback === "function") {
                callback(`Server error: ${error.message}`, false);
            }
            ...
            if (typeof callback === "function") {
                callback(`Request error: ${error.message}`, false);
            }
...
const _login = (server) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        const login = yield exec(server, ["sys_login", "login", [connections[server].user, connections[server].pass, "en"]]);
        if (login.error) {
            ...
            setTimeout(() => __awaiter(this, void 0, void 0, function* () { yield _login(server); }), reconnect_time);
            return null;
        }
        else {
...
const connect = () => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        for (const server of servers) {
            if (server.enabled) {
                const token = yield _login(server);
                // switch(server_type) {
