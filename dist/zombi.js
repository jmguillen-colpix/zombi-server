            ...
            case "POST":
                ...
                req.on('end', () => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        res.end(JSON.stringify(yield server.execute(mod, fun, args, token, seq, ip, ua)));
                    }
                    catch (error) {
                        stats.eup();
...
// Server startup
http_server.listen(config.server.http_port, () => __awaiter(this, void 0, void 0, function* () {
